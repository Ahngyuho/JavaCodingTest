...
class Prob4 {
    ...
    public static void main(String[] args){
        Prob4 T = new Prob4();
        System.out.println(T.solution1(new int[]{1, 2, 3}, 5));
        System.out.println(T.solution1(new int[]{8, 5, 2, 9, 10, 7}, 30));
        System.out.print(T.solution1(new int[]{8, 9, 12, 23, 45, 16, 25, 50}, 100));
    }
}